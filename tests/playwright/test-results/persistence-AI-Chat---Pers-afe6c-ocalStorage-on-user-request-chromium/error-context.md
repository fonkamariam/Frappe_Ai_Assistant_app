...
- Name: persistence.spec.ts >> AI Chat - Persistence >> should clear localStorage on user request
- Location: tests/persistence.spec.ts:120:7
...
Call log:
  - waiting for locator('button:has-text("Send")')
    - locator resolved to <button type="submit" class="btn btn-sm btn-primary btn-block btn-login-with-email-link">Send login link</button>
